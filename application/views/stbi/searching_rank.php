...
<div class="row justify-content-center">
    <div class="col-12 col-md-10 col-lg-8">
        <form class="card card-sm" action="<?=site_url('index.php/stbi/searching_rank')?>" method="get">
            ...
            foreach ($files->result_array() as $file) { ?>
                <div class="col-12 mb-3">
                    <a href="<?=base_url("assets/files/$file[nama_file]")?>" style="text-decoration:none">
                        <div class="card">
                            <div class="card-body">
                            <h5 class="card-title"><?=$file['nama_file']?></h5>
                            <h6 class="card-subtitle mb-2 text-muted">token : <?=$file['token']?></h6>
                            <h6 class="card-subtitle mb-2 text-muted">tokenstem : <?=$file['tokenstem']?></h6>
                            </div>
                        </div>
                    </a>
                </div>
